...
describe('PinResolver', () => {
  ...
  const oldWiki = {
    ...
    tags: [],
    metadata: [
      { id: CommonMetaIds.REFERENCES, value: '' },
      { id: EditSpecificMetaIds.COMMIT_MESSAGE, value: 'New Wiki Created 🎉' },
    ],
  ...
  const testWiki = {
    ...
    metadata: [
      { id: CommonMetaIds.REFERENCES, value: '' },
      { id: CommonMetaIds.FACEBOOK_PROFILE, value: '' },
      { id: CommonMetaIds.INSTAGRAM_PROFILE, value: '' },
      { id: CommonMetaIds.TWITTER_PROFILE, value: '' },
      { id: CommonMetaIds.LINKEDIN_PROFILE, value: '' },
      { id: CommonMetaIds.YOUTUBE_PROFILE, value: '' },
      { id: EditSpecificMetaIds.COMMIT_MESSAGE, value: 'New Wiki Created 🎉' },
      { id: EditSpecificMetaIds.WORDS_CHANGED, value: '2' },
      { id: EditSpecificMetaIds.PERCENT_CHANGED, value: '0.28' },
      { id: EditSpecificMetaIds.BLOCKS_CHANGED, value: 'content' },
    ],
    media: [],
  ...
  it('should return status false if wiki image keys are incorrect, expects ID and TYPE', async () => {
    ...
    expect(
      await ipfsValidatorService.validate(wiki as unknown as WikiType, true),
    ).toEqual({
      status: false,
      message: ValidatorCodes.IMAGE,
    })
